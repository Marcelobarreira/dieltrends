      ...
      <div className="container-app relative">
        ...
        <div className="w-full rounded-2xl bg-[linear-gradient(140.71deg,rgba(0,153,93,0)_0.01%,#00FF9B_94.12%)] p-1 lg:h-full">
          <div className="flex h-full w-full flex-col gap-6 sm:gap-10 lg:gap-15 rounded-2xl bg-[linear-gradient(140.71deg,rgba(0,153,93,0)_60%,rgba(0,255,155,0.25)_100%),linear-gradient(#010C28,#010C28)] p-4 sm:p-6 lg:flex-row lg:p-12">
            <div className="mt-4 sm:mt-8 flex w-full flex-col justify-between gap-6 sm:gap-12 py-4 sm:py-12">
              <div className="relative flex h-[180px] sm:h-[260px] w-full items-center justify-end lg:h-[305px]">
                <img
                  src={fotoex}
                  alt="foto exemplo"
                ...
                <div className="relative z-10 h-full w-full max-w-[85%] sm:max-w-[70%] rounded-tl-[60px] sm:rounded-tl-[100px] lg:rounded-tl-[140px] bg-[linear-gradient(100.29deg,#00FF9B_-6.47%,#010C28_101.93%)] p-0.5">
                  <div className="flex h-full flex-col justify-center rounded-tl-[60px] sm:rounded-tl-[100px] lg:rounded-tl-[140px] bg-[#010C28] p-4 sm:p-6 text-white">
                    <img className="h-8 w-8 sm:h-12 sm:w-12 self-end" src={iconlikedin} alt="icon-likedin" />
              ...
              <div className="relative flex h-[180px] sm:h-[260px] lg:h-[305px] w-full flex-row-reverse rounded-2xl rounded-tl-none bg-[linear-gradient(100.29deg,#00FF9B_-6.47%,#010C28_101.93%)] p-0.5">
              ...
              <div className="relative flex h-[180px] sm:h-[260px] lg:h-[305px] w-full items-center justify-end overflow-hidden rounded-tl-2xl rounded-bl-2xl">
                <img
                  src={fotoex}
                  alt=""
                  className="absolute left-0 top-0 z-0 h-full w-auto object-contain"
            ...
            <div className="mt-4 sm:mt-8 flex w-full flex-col items-end gap-8 sm:gap-16 text-left lg:max-w-[40%] lg:gap-90 lg:text-right">
