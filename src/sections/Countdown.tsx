  ...
  return (
    <section className="w-full py-12 sm:py-16 lg:py-24">
      <div className="container-app">
        ...
        <StaggerContainer staggerDelay={0.15} delayChildren={0.2} className="flex flex-wrap justify-center items-center gap-4 sm:gap-8 lg:gap-[100px]">
          {countdownItems.map((item, index) => (
            <motion.div key={index} variants={staggerItemScale} className="relative w-[100px] h-[100px] sm:w-[150px] sm:h-[150px] lg:w-[220px] lg:h-[220px]">
