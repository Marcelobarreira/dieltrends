  ...
  return (
    <section className="w-full pt-12 sm:pt-16 lg:pt-[89px] pb-12 sm:pb-16 lg:pb-20">
      ...
      <div className="container-app relative">
        ...
        <AnimatedSection variant="scaleIn" className="w-full sm:w-[90%] m-auto rounded-[20px] bg-[linear-gradient(150.71deg,rgba(0,153,93,0)_0.01%,#00FF9B_94.12%)] p-[2.7px] lg:h-full">
