      ...
      <div className="container-app relative">
        ...
        <div className="w-full rounded-[20px] bg-[linear-gradient(337.71deg,rgba(0,153,93,0)_.01%,#00FF9B_90.12%)] p-[2.8px] lg:h-full">
          <div className="flex flex-col h-full w-full p-5 sm:p-8 lg:p-15 rounded-[18px] bg-[linear-gradient(320.71deg,rgba(0,153,93,0)_60%,rgba(0,255,155,0.25)_100%),linear-gradient(#010C28,#010C28)] lg:flex-row">
            <div className="flex flex-col justify-between text-left mb-6 lg:mb-10">
              <div className="title">
            ...
            <div className="trend-cast slide flex items-center gap-4 lg:gap-10">
              ...
              <div className="relative flex flex-col justify-start rounded-2xl overflow-hidden w-full">
                <div className="rounded-tr-[120px] sm:rounded-tr-[200px] lg:rounded-tr-[268px] rounded-2xl bottom-0 left-0 absolute bg-[linear-gradient(200.71deg,rgba(0,153,93,0)_9.01%,#00FF9B_94.12%)] p-[1.3px]">
                  <div className="content-wrapper px-4 pt-4 pb-4 sm:px-6 sm:pt-6 sm:pb-6 lg:px-10 lg:pt-10 lg:pb-10 rounded-tr-[120px] sm:rounded-tr-[200px] lg:rounded-tr-[268px] rounded-2xl">
                    <h3 className="text-2xl sm:text-4xl lg:text-7xl font-bold mb-2 sm:mb-5">César Cielo</h3>
                    <p className="font-thin text-sm sm:text-lg lg:text-2xl leading-5 sm:leading-7 lg:leading-8 mb-2 sm:mb-5">Competitivo e incansável, Cielo transformou anos de suor em 21s30 de glória.</p>
                    <p className="font-thin text-sm sm:text-lg lg:text-2xl leading-5 sm:leading-7 lg:leading-8 hidden sm:block">Sem respirar por 34 braçadas, garantiu o primeiro ouro da natação brasileira. Poucos segundos na água que resumem uma vida inteira de motivação e trabalho duro.
                    </p>
                  </div>
                </div>
                <img src={cielo} alt="César Cielo" className="w-full lg:max-w-[700px] h-full object-cover" />
